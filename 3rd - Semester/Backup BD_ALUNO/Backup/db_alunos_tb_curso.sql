...
CREATE TABLE `tb_curso` (
  ...
  PRIMARY KEY (`idCurso`),
  UNIQUE KEY `NONCLUSTERED` (`nmCurso`)
...
INSERT INTO `tb_curso` VALUES (6,'Análise de Sistemas'),(4,'Arquitetura'),(5,'Ciência da Computação'),(3,'Direito'),(2,'Engenharia Civil'),(1,'Medicina');
